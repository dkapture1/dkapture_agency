...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden">
      {/* Top gradient line */}
      <div className="h-px w-full bg-gradient-to-r from-transparent via-[#FF4500] to-transparent" />
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  key={social.label}
                  href={social.href}
                  className="text-foreground/70 transition-colors duration-300 hover:text-[#FF4500]"
            ...
            <ul className="flex flex-col gap-3.5">
              {ecosystemLinks.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-sm text-[#666666] transition-colors duration-300 hover:text-[#FF4500]"
                  >
                    {link.label}
                  </a>
                </li>
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li>
                <button
                  type="button"
                  onClick={copyEmail}
                  className="group flex items-center gap-2 text-sm text-muted-foreground transition-colors duration-300 hover:text-[#FF4500]"
                >
                  {email}
                  {emailCopied ? (
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-2 text-sm text-muted-foreground transition-colors duration-300 hover:text-[#FF4500]"
                >
                  <svg
                    className="h-4 w-4"
                    viewBox="0 0 24 24"
